...
def aritmetica():
    if request.method == "POST":
        # Valores que recibio del form n1,n2 son pasados
...
def divisas():
    ...
    tipos_de_cambio = {
        'Dólar': 4184.21,  # Ejemplo: 1 USD = 4,211.61 COP
...
def calcular_edad():
    if request.method == "POST":
        ...
        if not fecha_nacimiento:
            ...
            return render_template('fecha.html')  # Cambiado a render_template
        ...
        try:
            ...
            return render_template('fecha.html', edad=edad)  # Retornar la plantilla con la edad
        except ValueError:
